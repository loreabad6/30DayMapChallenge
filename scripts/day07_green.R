...
center = st_sfc(st_point(c(-78.27237, 0.51469)), crs = 4386)
...
bg_tc = ee_as_thumbnail(
  ...
  vizparams = list(min = 0, max = 3000, gamma = 1.3)
) %>% st_set_crs(4326)
...
tm_shape(bg_tc, raster.downsample = F, bbox = circle_bbox) +
  ...
  tm_credits(
    ...
    "#30DayMapChallenge | Day 7: Green | Data: Sentinel-2 RGB:4∙3∙2 | Created by @loreabad6",
...
tmap_save(filename = "maps/day07.png")
